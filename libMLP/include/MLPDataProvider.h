...
protected:
	...
	LIBMLPAPI void release_buffers();
	LIBMLPAPI void reset_buffers();
    LIBMLPAPI void load_feature_batch(float *srcp, int *indexBase, int indexOffset);      // Load one batch of feature frames from the provider's internal buffer to the buffer ring
    LIBMLPAPI void load_label_batch(float *srcp, int *indexBase, int indexOffset);        // Load one batch of feature frames from the provider's internal buffer to the buffer ring

	LIBMLPAPI int startup_worker();
