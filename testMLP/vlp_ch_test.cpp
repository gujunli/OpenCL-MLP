...
void vlp_ch_training()
{
	...
	//dataProviderp = new MLPVLP_CHDataProvider(VLP_CH_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
	dataProviderp = new DNNPtcDataProvider(VLP_CH_DB_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
...
void vlp_ch_training2()
{
	...
	dataProviderp = new DNNPtcDataProvider(VLP_CH_DB_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
	//dataProviderp = new MLPVLP_CHDataProvider(VLP_CH_PATH3,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                            // set up the data provider
	totalbatches = dataProviderp->getTotalBatches();
...
void vlp_ch_training3()
{
	...
	if ( cpManager.cpAvailable() ) {
	     ...
	     //dataProviderp = new DNNPtcDataProvider(VLP_CH_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
	     dataProviderp = new DNNPtcDataProvider(VLP_CH_DB_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
...
void vlp_ch_batch_testing()
{
	...
	dataProviderp =	new DNNPtcDataProvider(VLP_CH_DB_PATH,  false, DNN_DATAMODE_TEST, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                              // set up the data provider
...
void vlp_ch_predicting()
{
	...
	configProviderp = new MLPConfigProvider("./", MLP_CP_NNET_DATA_NEW);
	dataProviderp =	new DNNPtcDataProvider(VLP_CH_DB_PATH,  false, DNN_DATAMODE_PREDICT, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                              // set up the data provider
