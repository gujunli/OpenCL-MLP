...
void ptc_en_batch_testing()
{
	...
	dataProviderp =	new DNNPtcDataProvider(PTC_EN_DB_PATH, DNN_DATAMODE_TEST, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                              // set up the data provider
...
void ptc_en_predicting()
{
	...
	netProviderp = new MLPNetProvider("./", MLP_NP_NNET_DATA_NEW);
	dataProviderp =	new DNNPtcDataProvider(PTC_EN_DB_PATH, DNN_DATAMODE_PREDICT, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                              // set up the data provider
