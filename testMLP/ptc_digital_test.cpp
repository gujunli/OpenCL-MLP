...
void ptc_digital_training()
{
	...
	//dataProviderp = new MLPptc_enDataProvider(ptc_digital_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
	dataProviderp = new DNNPtcDataProvider(PTC_DIGITAL_DB_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
...
void ptc_digital_training2()
{
	...
	dataProviderp = new DNNPtcDataProvider(PTC_DIGITAL_DB_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
	//dataProviderp = new MLPptc_enDataProvider(ptc_digital_PATH3,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                            // set up the data provider
	totalbatches = dataProviderp->getTotalBatches();
...
void ptc_digital_training3()
{
	...
	if ( cpManager.cpAvailable() ) {
	     ...
	     //dataProviderp = new DNNPtcDataProvider(ptc_digital_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
	     dataProviderp = new DNNPtcDataProvider(PTC_DIGITAL_DB_PATH,  false, DNN_DATAMODE_SP_TRAIN, minibatch, shuffleBatches);
...
void ptc_digital_batch_testing()
{
	...
	dataProviderp =	new DNNPtcDataProvider(PTC_DIGITAL_DB_PATH,  false, DNN_DATAMODE_TEST, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                              // set up the data provider
...
void ptc_digital_predicting()
{
	...
	configProviderp = new MLPConfigProvider("./", MLP_CP_NNET_DATA_NEW);
	dataProviderp =	new DNNPtcDataProvider(PTC_DIGITAL_DB_PATH,  false, DNN_DATAMODE_PREDICT, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                              // set up the data provider
