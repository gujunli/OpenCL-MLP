...
void ptc_symbol_training()
{
	...
	*/
	...
	//dataProviderp = new MLPptc_enDataProvider(ptc_symbol_PATH, DNN_DATAMODE_TRAIN, minibatch, shuffleBatches);
	dataProviderp = new DNNPtcDataProvider(PTC_SYMBOL_DB_PATH, DNN_DATAMODE_TRAIN, minibatch, shuffleBatches);
...
void ptc_symbol_training2()
{
	...
	dataProviderp = new DNNPtcDataProvider(PTC_SYMBOL_DB_PATH, DNN_DATAMODE_TRAIN, minibatch, shuffleBatches);
	//dataProviderp = new MLPptc_enDataProvider(ptc_symbol_PATH3, DNN_DATAMODE_TRAIN, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                            // set up the data provider
	totalbatches = dataProviderp->getTotalBatches();
...
void ptc_symbol_training3()
{
	...
	if ( cpManager.cpAvailable() ) {
	     ...
	     //dataProviderp = new DNNPtcDataProvider(ptc_symbol_PATH, DNN_DATAMODE_TRAIN, minibatch, shuffleBatches);
	     dataProviderp = new DNNPtcDataProvider(PTC_SYMBOL_DB_PATH, DNN_DATAMODE_TRAIN, minibatch, shuffleBatches);
