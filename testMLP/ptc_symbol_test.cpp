...
void ptc_symbol_training()
{
	...
	*/
	...
	//dataProviderp = new MLPptc_enDataProvider(ptc_symbol_PATH, MLP_DATAMODE_TRAIN, minibatch, shuffleBatches);
	dataProviderp = new MLPPtcDataProvider(PTC_SYMBOL_DB_PATH, MLP_DATAMODE_TRAIN, minibatch, shuffleBatches);
...
void ptc_symbol_training2()
{
	...
	dataProviderp = new MLPPtcDataProvider(PTC_SYMBOL_DB_PATH, MLP_DATAMODE_TRAIN, minibatch, shuffleBatches);
	//dataProviderp = new MLPptc_enDataProvider(ptc_symbol_PATH3, MLP_DATAMODE_TRAIN, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                            // set up the data provider
	totalbatches = dataProviderp->getTotalBatches();
...
void ptc_symbol_training3()
{
	...
	if ( cpManager.cpAvailable() ) {
	     ...
	     //dataProviderp = new MLPPtcDataProvider(ptc_symbol_PATH, MLP_DATAMODE_TRAIN, minibatch, shuffleBatches);
	     dataProviderp = new MLPPtcDataProvider(PTC_SYMBOL_DB_PATH, MLP_DATAMODE_TRAIN, minibatch, shuffleBatches);
...
void ptc_symbol_batch_testing()
{
	...
	dataProviderp =	new MLPPtcDataProvider(PTC_SYMBOL_DB_PATH, MLP_DATAMODE_TEST, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                              // set up the data provider
...
void ptc_symbol_predicting()
{
	...
	netProviderp = new MLPNetProvider("./", MLP_NP_NNET_DATA_NEW);
	dataProviderp =	new MLPPtcDataProvider(PTC_SYMBOL_DB_PATH, MLP_DATAMODE_PREDICT, minibatch, shuffleBatches);
	dataProviderp->setupDataProvider();                              // set up the data provider
